-- Adds "Purchasing Department" as a real app_users role (previously only a
...
alter table approver_mappings drop constraint if exists approver_mappings_approver_role_check;
alter table approver_mappings add constraint approver_mappings_approver_role_check
