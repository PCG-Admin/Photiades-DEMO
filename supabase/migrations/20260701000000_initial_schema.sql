-- ============================================================
-- PCG | MindRift Workflow Portal — initial schema
...
-- ---------- invoice_app_users (SOW §5.8 User Administration) ----------
...
-- ---------- invoice_documents (SOW §5.1 Capture queue) ----------
...
-- ---------- invoice_workflow_instances (SOW §5.3/§5.4 — Stock 7 tasks / Non-Stock 8 tasks) ----------
...
-- ---------- invoice_audit_events (SOW §6 Audit) ----------
...
-- ---------- invoice_notifications (SOW §4 — Email / in-app task alerts) ----------
